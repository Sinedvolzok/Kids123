...
struct Payment {
    ...
    let cancelButton:UIButton = {
        ...
        //button style
        button.backgroundColor = #colorLiteral(red: 0.2980392157, green: 0.3254901961, blue: 0.9607843137, alpha: 1)
        button.layer.cornerRadius = 16
        
        //button image style
        button.setImage(#imageLiteral(resourceName: "ClouseImage"), for: .normal)
...
//        button.contentEdgeInsets = UIEdgeInsets(top: 4,left: 16,bottom: 4,right: 16) way to use whith button as content whith!!! UHA!
    ...
    let parentControllView:UIView = {
        ...
        view.backgroundColor = #colorLiteral(red: 0.2980392157, green: 0.3254901961, blue: 0.9607843137, alpha: 1)
    ...
    let birthYearTextFieldView:UIView = {
        let view = UIView()
        view.backgroundColor = #colorLiteral(red: 0.2776230568, green: 0.3110726596, blue: 0.9153665676, alpha: 1)
